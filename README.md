...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ppj1qtq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ppj1qtq.containers.anotherwebservice.com/
...
```
git clone git@github.com:aviskumar/container-ppj1qtq.git
cd container-ppj1qtq
```
...
```
docker attach container-ppj1qtq
```
